...
<head>
	...
	<link rel="icon" type="image/png" href="https://laurcons.ddns.net/media/favicon-16x16.ico" />

	<link rel="icon" type="image/png" href="https://laurcons.ddns.net/media/favicon-32x32.ico" />
	...
	<div id="center_div">
		...
		<div id="slideshow">
			...
			<div class="slides">
				...
				<img src="https://laurcons.ddns.net/media/poze/poza1.png" id="center_image_main" />

			</div>

			<div class="slides">
				
				<img src="https://laurcons.ddns.net/media/poze/poza2.png" id="center_image_main" />
				
			</div>

			<div class="slides">
				
				<img src="https://laurcons.ddns.net/media/poze/poza3.png" id="center_image_main" />
				
			</div>

			<div class="slides">
				
				<img src="https://laurcons.ddns.net/media/poze/poza4.jpg" id="center_image_main" />
				
			</div>

			<div class="slides">
				
				<img src="https://laurcons.ddns.net/media/poze/poza5.jpg" id="center_image_main" />
